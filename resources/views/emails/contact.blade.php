...
<html lang="es-ES" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
<head>
    <title>Coach WMT</title>
                            ...
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        style="mso-table-lspace:0;mso-table-rspace:0;background-color:#f9f9f9;color:#000;width:680px"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <a href="https://coachwmt.com/"
                                                                        style="outline:none" tabindex="-1"
                                                                        target="_blank"><img
                                                                            alt="Coach WMT logo"
                                                                            src="https://coachwmt.com/lib/images/logo.png"
                                                                            style="display:block;height:auto;border:0;width:282px;max-width:100%"
                                                                            title="Coach WMT logo"
                                                                            width="282" /></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                ...
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    style="mso-table-lspace:0;mso-table-rspace:0;font-weight:400;text-align:left;vertical-align:top;padding-top:20px;padding-bottom:20px;border-top:0;border-right:0;border-bottom:0;border-left:0"
                                                    width="100%">
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div style="font-family:Verdana,sans-serif">
                                                                    <div class=""
                                                                        style="font-size:14px;font-family:'Lucida Sans Unicode','Lucida Grande','Lucida Sans',Geneva,Verdana,sans-serif;mso-line-height-alt:16.8px;color:#2f2f2f;line-height:1.2">
                                                                        <p
                                                                            style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
                                                                            <strong><span style="font-size:42px;">Mensaje Recibido</span></strong>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div style="font-family:sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:24px">
                                                                            <span style="font-size:16px;">Fecha:
                                                                                <strong><span>{{ $date }}</span></strong>
                                                                            </span>
                                                                        </p>
                                                                        <p
                                                                            style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:24px">
                                                                            <span style="font-size:16px;">Correo:
                                                                        ...
                                                                        <p
                                                                            style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:24px">
                                                                            <span style="font-size:16px;">Asunto:
                                                                                <strong><span>{{ $subject }}</span></strong>
                                                                            </span>
                                                                        </p>
                                                                        <p
                                                                            style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:21px">
                                                                            <span style="color:#000000;font-size:14px;">{{ $message_user }}</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace:0;mso-table-rspace:0;background-color:#5d77a9;color:#000;width:680px"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:15px;padding-left:15px;padding-right:15px;padding-top:35px;text-align:center">
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family:sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin:0;text-align:center;mso-line-height-alt:21px">
                                                                            Calle 93 Avenida Padilla, Maracaibo</p>
                                                                        <p
                                                                            style="margin:0;font-size:12px;text-align:center;mso-line-height-alt:18px">
                                                                            iglesiadelacruzweb@gmail.com</p>
                                                                        <p
                                                                            style="margin:0;font-size:12px;text-align:center;mso-line-height-alt:18px">
                                                                            +58 412 766 4065</p>
                                                                    </div>
